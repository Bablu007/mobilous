...
public class InsertDealerDetails {

	public static boolean insertdealerdetails (String where) throws ParseException, IOException, org.json.simple.parser.ParseException, ClassNotFoundException, SQLException {
	 ...
	 // String aso=stk.nextToken();
		...
		//URL url=new URL("https://tslapps.tatasteel.co.in/eca/api/TisconDealers/InsertDealerDetails");
	    //URL url=new URL("https://tslappsqa.tatasteel.co.in/eca/api/TisconDealers/InsertDealerDetails");
	    URL url=new URL("https://tslapps.tatasteel.co.in/eca/api/TisconDealers/InsertDealerDetails");
	    String zone=get_zone(state);
	    
	    System.out.println("https://tslapps.tatasteel.co.in/eca/api/TisconDealers/InsertDealerDetails");
