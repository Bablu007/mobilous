...
public class FetchSKUDescription {

	public JSONArray fetchSkuDescription(String where) throws Exception {
		...
		String path_name = "https://tslappsqa.tatasteel.co.in/eca/api/agrimat/GetMaterialData";
...
//		conn.setRequestProperty("Content-type", "application/json");
		...
		if(conn.getResponseCode() != HttpStatus.SC_UNPROCESSABLE_ENTITY) {
			...
			JSONArray jarr2 = (JSONArray) parser.parse(response.toString());
			
			JSONObject jobject2 = (JSONObject)jarr2.get(0);
			
			String skucode = (String) jobject2.get("matnr");
			String skudescription = (String) jobject2.get("matdesc");
			JSONObject jobject1 = new JSONObject();
			jobject1.put("skucode", skucode);
			jobject1.put("skudescription", skudescription);
